        ...
        <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative">
              ...
              <div className="relative">
                <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl mt-16">
                  <img
                    ...
                    <div className="space-y-3">
                      ...
                      {selectedUserType && (
                        <motion.div
                          ...
                          className={`p-3 rounded-lg border ${selectedUserType.color} bg-opacity-20 border-opacity-30 backdrop-blur-sm`}
                        >
                          <div className="flex items-center gap-3">
