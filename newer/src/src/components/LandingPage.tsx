            ...
            >
              <div className="relative">
                ...
                <motion.div
                  ...
                  className="relative z-10 w-full max-w-lg h-80 bg-gradient-to-br from-gray-900/90 to-gray-800/90 rounded-xl shadow-2xl border border-white/10 p-6"
                >
                  <div className="text-white mb-4">
                    <h3 className="text-lg font-semibold">Dashboard Preview</h3>
                    <p className="text-gray-300 text-sm">AI Timetable Management</p>
                  </div>
                  <div className="space-y-3">
                    <div className="flex items-center gap-3 p-2 bg-white/10 rounded">
                      <Calendar className="h-4 w-4 text-orange-400" />
                      <span className="text-sm text-white">24 Classes Scheduled</span>
                    </div>
                    <div className="flex items-center gap-3 p-2 bg-white/10 rounded">
                      <Users className="h-4 w-4 text-green-400" />
                      <span className="text-sm text-white">18 Faculty Available</span>
                    </div>
                    <div className="flex items-center gap-3 p-2 bg-white/10 rounded">
                      <CheckCircle className="h-4 w-4 text-blue-400" />
                      <span className="text-sm text-white">0 Conflicts Detected</span>
                    </div>
                  </div>
                </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {testimonials.map((testimonial, index) => {
                ...
                return (
                  ...
                  >
                    <Card className={`bg-gradient-to-br ${cardGradients[index]} text-white h-full shadow-xl hover:shadow-2xl transition-all duration-300 border-0`}>
